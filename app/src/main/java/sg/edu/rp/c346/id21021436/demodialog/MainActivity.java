package sg.edu.rp.c346.id21021436.demodialog;
...
//                myBuilder.setPositiveButton("Close", null);
                ...
                //some extra stuff I tried out on my own
...
//                });
                ...
                //Updated the 'positive' button to 'Yes'
...
//                });
                ...
                //Updated the 'negative' button to 'No'
...
//                myDialog.show();
        ...
        btnExercise3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                LayoutInflater inflater = (LayoutInflater) getSystemService(Context.LAYOUT_INFLATER_SERVICE);
                View viewDialog = inflater.inflate(R.layout.input_exercise_3, null);

                final EditText etNumber1, etNumber2;
                etNumber1 = viewDialog.findViewById(R.id.editTextNumber1);
                etNumber2 = viewDialog.findViewById(R.id.editTextNumber2);
                ...
                myBuilder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        tvExercise3.setText("The sum is " + String.valueOf(number1 + number2));
                    }
                });
...
//                //Create the Time Picker Dialog with AM/PM display
